...
@interface LTCBlock ()
@property(nonatomic, readwrite) LTCBlockHeader* header;
@end

@implementation LTCBlock

- (id) init {
    if (self = [super init]) {
        self.header = [[LTCBlockHeader alloc] init];
    }
    return self;
}

- (id) initWithHeader:(LTCBlockHeader*)header {
    if (self = [super init]) {
        self.header = header;
    }
    return self;
...
- (id) copyWithZone:(NSZone *)zone {
    LTCBlock* b = [[LTCBlock alloc] init];
