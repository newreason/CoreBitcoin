...
+ (LTCNetwork*) mainnet {
    static LTCNetwork* network;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        
        network = [[LTCNetwork alloc] initWithName:@"mainnet" paymentProtocolName:@"main"];
...
+ (LTCNetwork*) testnet {
    ...
    dispatch_once(&onceToken, ^{
        ...
        network = [[LTCNetwork alloc] initWithName:@"testnet3" paymentProtocolName:@"test"];
...
- (id) copyWithZone:(NSZone *)zone {
    LTCNetwork* network = [[LTCNetwork alloc] copy];
